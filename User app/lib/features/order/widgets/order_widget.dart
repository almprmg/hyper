                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Row(children: [
                    Expanded(child: Text('${getTranslated('order', context)!}# ${orderModel!.id.toString()}',
                      style: textMedium.copyWith(fontSize: Dimensions.fontSizeDefault, fontWeight: FontWeight.bold, color: Theme.of(context).textTheme.bodyLarge?.color )))]),
                  ...
                  children: [
                    ...
                    RichText(
                      text: TextSpan(
                        ...
                        children: <TextSpan>[
                          TextSpan(
                            text: '${orderModel?.orderDetailsCount}',
