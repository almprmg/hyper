...
class CartScreenState extends State<CartScreen> {
  ...
  void _scrollToSeller(int? index) {
    if(index != null) {
      ...
      if (context != null) {
        Scrollable.ensureVisible(
          ...
          alignment: 0.1, // optional: how much from top
        );
      }
    }
  }
                      ...
                      Column(children: [
                        ...
                        InkWell(onTap: () {
                              ...
                              if(configProvider.configModel?.guestCheckOut == 0 && !Provider.of<AuthController>(context, listen: false).isLoggedIn()){
                                ...
                                changeColor();
                                showCustomSnackBar('${getTranslated('minimum_order_amount', context)} ${PriceConverter.convertPrice(context, requiredMinOrderAmountCart?.sellerCart.minimumOrderAmountInfo)} ${getTranslated('for', context)} ${requiredMinOrderAmountCart?.sellerCart.shop?.name}', context);
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return AnimatedContainer(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  index.floor().isOdd ? Theme.of(context).colorScheme.onSecondaryContainer : Theme.of(context).cardColor,
                                            ...
                                            Padding(
                                              ...
                                              child: Row(children: [
                                                Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    color: (sellerGroupList[index].freeDeliveryOrderAmount!.percentage! < 100) ?
                                                    Theme.of(context).colorScheme.onSecondary: Theme.of(context).colorScheme.onTertiaryContainer,
                                                    borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                                                  ),
                                                  child: CustomAssetImageWidget(Images.freeDeliveryIcon)
                                                ),
                                                ...
                                                Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraSmall),
                                                  child: Text('${getTranslated('you_got_free_delivery', context)}', style: textMedium.copyWith(color: Theme.of(context).textTheme.titleMedium?.color)),
                                                )
                                              ],),
                                            ),
