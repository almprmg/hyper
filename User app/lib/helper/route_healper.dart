...
class RouterHelper {
  ...
  static String getOrderScreenRoute({RouteAction? action, bool isBackButtonExist = true}) {
    final query = '?isBackButtonExist=$isBackButtonExist';
    return _navigateRoute('$orderScreen$query', route: action);
  }
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          final cartList = (jsonDecode(Uri.decodeComponent(qp['cartList'] ?? '[]')) as List)
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return OrderScreen(isBacButtonExist: isBackButtonExist);
        },
      ),
